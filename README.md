...
Note: API keys are included for demo purposes. For production use, consider implementing environment variables or a backend service.
...
Voice recognition works best in WebKit-based browsers (Chrome, Edge)
